...
export async function processCarImageWithAI(file) {
  try {
    ...
    const prompt = `
      Carefully analyze this car image and extract ALL the following information with high accuracy:
      1. Make (manufacturer) - Look for logos, badges, distinctive design elements
      2. Model - The specific model name/number
      3. Year (approximately) - Estimate based on design language
      4. Color - Primary exterior color
      5. Body type (SUV, Sedan, Hatchback, Truck, Coupe, etc.)
      6. Mileage - If visible on image, otherwise estimate as reasonable guess
      7. Fuel type (Petrol, Diesel, Electric, Hybrid - your best guess based on design)
      8. Transmission type (Manual or Automatic - your best guess)
      9. Price - Your best estimate in INR
      10. Short Description - 2-3 sentences for a car listing

      IMPORTANT: Be accurate with the make/model by examining:
      - Brand logos and emblems
      - Distinctive design characteristics
      - Grille shape, headlight design, body proportions
      - Any visible badges or trim indicators
      ...
      Confidence: value between 0 and 1 (1.0 = very confident in identification)
