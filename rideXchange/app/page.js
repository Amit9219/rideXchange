import { ChevronRight, Car, Calendar, Shield, Wrench } from "lucide-react";
    ...
    <div className="flex flex-col pt-20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find your Dream Car with RideXchange
            </h1>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          {/* Debug / fallback */}
          {!featuredCars || (Array.isArray(featuredCars) && featuredCars.length === 0) ? (
            <div className="text-center py-12 text-gray-500">
              No featured cars available right now.
              <div className="mt-2 text-sm text-gray-400">
                Check server logs or network requests for `getFeaturedCars`.
              </div>
            </div>
          ) : (
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl font-bold mb-4">Vehicle Service & Maintenance</h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Keep your vehicle in top condition with our professional service center.
              Book your service appointment online at your convenience.
            </p>
