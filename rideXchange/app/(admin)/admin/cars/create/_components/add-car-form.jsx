...
export const AddCarForm = ({
  mode = "admin", // "admin" or "public"
  redirectPath = "/admin/cars",
  submitLabel,
} = {}) => {
  ...
  // For public Sell Car page, default to manual entry and hide AI tab.
  const [activeTab, setActiveTab] = useState(mode === "admin" ? "ai" : "manual");
  ...
  }, [addCarResult, redirectPath, router]);
  ...
  return (
    <div>
      <Tabs
        defaultValue={mode === "admin" ? "ai" : "manual"}
        value={mode === "admin" ? activeTab : "manual"}
        onValueChange={mode === "admin" ? setActiveTab : undefined}
        className="mt-6"
      >
        {mode === "admin" && (
                ...
                >
                  {addCarLoading ? (
                    <>
                      ...
                      {mode === "admin" ? "Adding Car..." : "Listing Car..."}
                    </>
                  ) : (
                    submitLabel || (mode === "admin" ? "Add Car" : "List My Car")
                  )}
                </Button>
              </form>
            </CardContent>
