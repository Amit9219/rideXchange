...
export function CarDetails({ car, testDriveInfo }) {
  ...
  // Show thank-you message after a completed test drive
  useEffect(() => {
    if (testDriveInfo?.userTestDrive?.status === "COMPLETED") {
      toast.success(
        "Thanks for taking a test drive with RideXchange. We hope you enjoyed the drive! If this feels like the right car, you can complete your purchase using the Buy This Car button."
      );
    }
  ...
  // Handle buy car - redirect to Buy flow
  const handleBuyCar = () => {
    if (!isSignedIn) {
      toast.error("Please sign in to buy cars");
      router.push("/sign-in");
      return;
    }

    router.push(`/buy/${car.id}`);
  };
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>RideXchange Car Loan Calculator</DialogTitle>
          ...
          {car.status !== "SOLD" && car.status !== "UNAVAILABLE" && (
            <div className="space-y-3">
              ...
              >
                ...
                {testDriveInfo?.userTestDrive?.status === "COMPLETED"
                  ? "Buy This Car"
                  : "Buy Car"}
              </Button>
